...
xeroaccounting = Integration.load()
...
@xeroaccounting.action("get_tenant_by_company_name")
...
@xeroaccounting.action("find_contact_by_name")
...
@xeroaccounting.action("get_aged_payables")
...
@xeroaccounting.action("get_aged_receivables")
...
@xeroaccounting.action("get_balance_sheet")
...
@xeroaccounting.action("get_profit_and_loss")
...
@xeroaccounting.action("get_trial_balance")
