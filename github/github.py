...
class GitHubAPI:
    ...
    async def remove_pull_request_reviewers(context: ExecutionContext, owner: str, repo: str,
        ...
        return await context.fetch(url, method="DELETE", json=data)
    ...
    async def create_webhook(context: ExecutionContext, owner: str, repo: str,
        ...
        return await context.fetch(webhook_url, method="POST", json=data)
    ...
    async def get_file_content(context: ExecutionContext, owner: str, repo: str,
        ...
        response = await context.fetch(url, params=params if params else None)
...
# Note: All actions return ActionResult with cost_usd=0.0 since GitHub API is free
